...
#define SYSCALL_TRACE_ENTER_EVENT(sname)                   \
    ...
    static struct trace_event_call __used                  \
        __attribute__((section("_ftrace_events")))* __event_enter_##sname = &event_enter_##sname;
...
#define SYSCALL_TRACE_EXIT_EVENT(sname)                    \
    ...
    static struct trace_event_call __used                  \
        __attribute__((section("_ftrace_events")))* __event_exit_##sname = &event_exit_##sname;
...
#define SYSCALL_METADATA(sname, nb, ...)                                         \
    ...
    static struct syscall_metadata __used                                        \
        __attribute__((section("__syscalls_metadata")))* __p_syscall_meta_##sname = &__syscall_meta_##sname;
#else
#define SYSCALL_METADATA(sname, nb, ...)
#endif
...
asmlinkage long sys_preadv2(unsigned long fd, const struct iovec __user* vec, unsigned long vlen, unsigned long pos_l, unsigned long pos_h, int flags);
...
asmlinkage long sys_pwritev2(unsigned long fd, const struct iovec __user* vec, unsigned long vlen, unsigned long pos_l, unsigned long pos_h, int flags);
...
asmlinkage long sys_ps_info(pid_t __user* pids, char __user* commands, long __user* states, unsigned long long __user* runtimes, int __user* num);
